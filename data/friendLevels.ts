...
export const FRIEND_LEVELS = [
    {
        days: 30, level: 1, title: '初遇', icon: 'lucide:sparkles',
    ...
    {
        days: 60, level: 2, title: '萌芽', icon: 'lucide:sprout',
    ...
    {
        days: 90, level: 3, title: '抽叶', icon: 'lucide:leaf',
    ...
    {
        days: 180, level: 4, title: '绽放', icon: 'lucide:flower-2',
    ...
    {
        days: 270, level: 5, title: '轻语', icon: 'lucide:feather',
    ...
    {
        days: 365, level: 6, title: '听风', icon: 'lucide:wind',
    ...
    {
        days: 450, level: 7, title: '云游', icon: 'lucide:cloud',
    ...
    {
        days: 540, level: 8, title: '润泽', icon: 'lucide:droplets',
    ...
    {
        days: 630, level: 9, title: '凝冰', icon: 'lucide:snowflake',
    ...
    {
        days: 730, level: 10, title: '磐石', icon: 'lucide:mountain',
    ...
    {
        days: 900, level: 11, title: '坚守', icon: 'lucide:shield',
    ...
    {
        days: 1080, level: 12, title: '燃情', icon: 'lucide:flame',
    ...
    {
        days: 1460, level: 13, title: '烈阳', icon: 'lucide:sun',
    ...
    {
        days: 1825, level: 14, title: '雷鸣', icon: 'lucide:zap',
    ...
    {
        days: 2190, level: 15, title: '传世', icon: 'lucide:crown',
...
export type FriendLevel = typeof FRIEND_LEVELS[0];
